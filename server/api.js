...
router.post('/register', (req, res) => {
  ...
  bcrypt.hash(req.body.password, saltRounds, function (err, hash) {
    ...
    Queries.run(q1).then((results) => {
      ...
      registerEmailParams.subject = 'Welcome to Budget Suites!'
      registerEmailParams.text = 'Thank you for registering an account to Budget Suites! Start booking reservations now!'
