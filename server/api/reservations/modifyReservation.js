...
async function modifyReservation(requestedBooking, transaction_id, res) {
    ...
    connection.beginTransaction(async function (err) {
        ...
        emailParams.subject = 'Your Budget Suites Booking Has Been Modified!'
        // emailParams.text = 'Hello. Thank you for booking a reservation using Budget Suites. This is an email to confirm you order for: \n' + JSON.stringify(requestedBooking);
